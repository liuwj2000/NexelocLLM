...
def load_history_data(name,type):
    file_dir='/home_nfs/liushuai/data/gridize_notebooks/XIAN/llmmob/history_'+name+'_'+type+'.pkl'
    #print(file_dir)
    f=open(file_dir,'rb')
    data=pickle.load(f)
...
def load_content_data(name,type):
    file_dir='/home_nfs/liushuai/data/gridize_notebooks/XIAN/llmmob/context_'+name+'_'+type+'.pkl'
    #print(file_dir)
    f=open(file_dir,'rb')
    data=pickle.load(f)
    #print('load file: ',f,' finished')
...
def load_content_data_true(name,type):
    file_dir='/home_nfs/liushuai/data/gridize_notebooks/XIAN/llmmob/context_true_'+name+'_'+type+'.pkl'
    #print(file_dir)
    f=open(file_dir,'rb')
    data=pickle.load(f)
    #print('load file: ',f,' finished')
